    ...
    <>
      <div className='person-outer'>
        ...
        <div className='spotify-section'>
          <iframe width="450" height="300" src="https://www.youtube.com/embed/BW3gKKiTvjs" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture"></iframe>
        </div>
      </div>
      <div className='person-outer'>
        <div className='person-inner'>
